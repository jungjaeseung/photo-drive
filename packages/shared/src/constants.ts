...
export const ES_INDEX_FAVORITES = "photo-drive-favorites";
export const QUEUE_MEDIA = "photo-drive-media";

export const THUMB_MAX_SIZE = 320;
export const MEDIUM_MAX_SIZE = 1280;
/** WebP quality (0–100) for thumb.webp / medium.webp */
export const THUMB_WEBP_QUALITY = 65;
export const MEDIUM_WEBP_QUALITY = 75;
export const VIDEO_PREVIEW_SECONDS = 8;
